...
pub struct ActiveInterface {
    ...
    pub is_present: Option<Box<UnsignedBitExpression>>,
...
pub struct AddressBankType {
    ...
    pub access: Option<Box<AccessType>>,
...
pub struct AddressBlockType {
    ...
    pub width: Option<Box<UnsignedIntExpression>>,
...
pub struct AdHocConnection {
    ...
    pub tied_value: Option<Box<ComplexTiedValueType>>,
...
pub struct BusInterfaceType {
    ...
    pub mirrored_slave: Option<String>,

    #[serde(rename = "mirroredMaster", skip_serializing_if = "Option::is_none")]
    pub mirrored_master: Option<String>,
    ...
    pub bit_steering: Option<Box<ComplexBitSteeringExpression>>,
...
pub struct ClockDriverType {
    ...
    pub clock_pulse_value: Option<Box<UnsignedBitVectorExpression>>,
...
#[derive(Debug, Clone, PartialEq, Default, Serialize, Deserialize)]
pub struct ComplexBitSteeringExpression {
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
}

#[derive(Debug, Clone, PartialEq, Default, Serialize, Deserialize)]
pub struct ComplexTiedValueType {
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<String>,
...
pub struct ComponentType {
    ...
    pub whitebox_elements: Option<Box<super::component::WhiteboxElements>>,

    #[serde(rename = "cpus", skip_serializing_if = "Option::is_none")]
    pub cpus: Option<Box<super::component::Cpus>>,
...
pub struct ConfigurableLibraryRefType {
    #[serde(
        rename = "configurableElementValues",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct EnumeratedValues {
    ...
    pub enumerated_value: Vec<super::EnumeratedValue>,
}
...
pub struct FieldType {
    ...
    pub modified_write_value: Option<Box<super::ModifiedWriteValue>>,

    #[serde(
        rename = "writeValueConstraint",
        skip_serializing_if = "Option::is_none"
    )]
    pub write_value_constraint: Option<Box<WriteValueConstraintType>>,

    #[serde(rename = "readAction", skip_serializing_if = "Option::is_none")]
    pub read_action: Option<Box<super::ReadAction>>,
    ...
    pub reserved: Option<Box<UnsignedBitExpression>>,
...
pub struct File {
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<Box<super::StringURIExpression>>,
...
pub struct FileBuilderType {
    ...
    pub command: Option<Box<super::StringExpression>>,

    #[serde(rename = "flags", skip_serializing_if = "Option::is_none")]
    pub flags: Option<Box<super::StringExpression>>,

    #[serde(
        rename = "replaceDefaultFlags",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct GroupSelector {
    ...
    #[serde(
        rename = "multipleGroupSelectionOperator",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct IndirectInterfaceType {
    ...
    pub indirect_address_ref: Option<String>,

    #[serde(rename = "indirectDataRef", skip_serializing_if = "Option::is_none")]
    pub indirect_data_ref: Option<String>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum IpxactFileTypesEnum {
    #[serde(rename = "busDefinition")]
    BusDefinition,
    #[serde(rename = "abstractionDefinition")]
    AbstractionDefinition,
    #[serde(rename = "component")]
    Component,
    #[serde(rename = "abstractor")]
    Abstractor,
    #[serde(rename = "design")]
    Design,
    #[serde(rename = "designConfig")]
    DesignConfig,
    #[serde(rename = "generatorChain")]
    GeneratorChain,
...
pub struct LinkerCommandFile {
    ...
    pub command_line_switch: Option<Box<super::StringExpression>>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub enum ModelInstantiationType {
    #[serde(rename = "module")]
    Module,
    #[serde(rename = "entity(architecture)")]
    EntityArchitecture,
...
pub struct NameValuePairType {
    ...
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<super::StringExpression>>,
...
pub struct ParameterBaseType {
    ...
    pub arrays: Option<Box<super::ConfigurableArrays>>,

    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<Box<ComplexBaseExpression>>,
...
pub struct PathSegmentType {
    #[serde(rename = "pathSegmentName", skip_serializing_if = "Option::is_none")]
    pub path_segment_name: Option<String>,
...
pub struct Protocol {
    ...
    pub protocol_type: Option<Box<PortProtocolType>>,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct PortProtocolType {
    #[serde(rename = "@custom", skip_serializing_if = "Option::is_none")]
    pub custom: Option<String>,

    #[serde(rename = "$text")]
    pub value: ProtocolTypeType,
}
...
pub struct RemapStates {
    #[serde(rename = "remapState")]
    pub remap_state: Vec<super::RemapState>,
}
...
#[derive(Debug, Clone, PartialEq, Default, Serialize, Deserialize)]
pub struct SignedIntExpression {
    #[serde(rename = "minimum", skip_serializing_if = "Option::is_none")]
    pub minimum: Option<i32>,
...
impl From<&str> for SignedLongintExpression {
    fn from(value: &str) -> Self {
        Self::new(value)
    }
}

impl From<String> for SignedLongintExpression {
...
pub struct SingleShotDriver {
    ...
    pub single_shot_offset: Option<Box<RealExpression>>,

    #[serde(rename = "singleShotValue", skip_serializing_if = "Option::is_none")]
    pub single_shot_value: Option<Box<UnsignedBitVectorExpression>>,

    #[serde(rename = "singleShotDuration", skip_serializing_if = "Option::is_none")]
    pub single_shot_duration: Option<Box<RealExpression>>,
}
...
impl From<&str> for UnsignedBitVectorExpression {
    fn from(value: &str) -> Self {
        Self::new(value)
    }
}

impl From<String> for UnsignedBitVectorExpression {
    fn from(value: String) -> Self {
        Self::new(value)
    }
}
...
impl From<&str> for UnsignedLongintExpression {
    fn from(value: &str) -> Self {
        Self::new(value)
    }
}

impl From<String> for UnsignedLongintExpression {
    fn from(value: String) -> Self {
        Self::new(value)
    }
}
...
impl From<&str> for UnsignedPositiveIntExpression {
    fn from(value: &str) -> Self {
        Self::new(value)
    }
}

impl From<String> for UnsignedPositiveIntExpression {
    fn from(value: String) -> Self {
        Self::new(value)
    }
}
...
impl From<&str> for UnsignedPositiveLongintExpression {
    fn from(value: &str) -> Self {
        Self::new(value)
    }
}

impl From<String> for UnsignedPositiveLongintExpression {
    fn from(value: String) -> Self {
        Self::new(value)
    }
}
...
pub struct WhiteboxElementType {
    ...
    #[serde(rename = "whiteboxType", skip_serializing_if = "Option::is_none")]
    pub whitebox_type: Option<Box<SimpleWhiteboxType>>,
