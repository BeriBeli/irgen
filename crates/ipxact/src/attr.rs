...
pub(crate) fn extract_access_value(attr: &str) -> Result<String> {
...
pub(crate) fn extract_modified_write_value(attr: &str) -> Result<Option<String>> {
    match attr.to_ascii_uppercase().as_str() {
...
pub(crate) fn extract_read_action_value(attr: &str) -> Result<Option<String>> {
    match attr.to_ascii_uppercase().as_str() {
