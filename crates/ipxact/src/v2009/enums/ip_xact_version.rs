...
mod tests {
    ...
    fn test_from_namespace() {
        ...
        assert_eq!(
            IpXactVersion::from_namespace("http://other.namespace"),
            None
        );
    }
    ...
    fn test_from_string() {
        assert_eq!(
            IpXactVersion::from_string("1685-2009"),
            Some(IpXactVersion::Ieee1685_2009)
        );
        assert_eq!(
            IpXactVersion::from_string("IEEE_1685_2014"),
            Some(IpXactVersion::Ieee1685_2014)
        );
