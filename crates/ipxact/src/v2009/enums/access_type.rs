...
mod tests {
    ...
    fn test_access_type_from_str() {
        assert_eq!(
            AccessType::from_str("read-only").unwrap(),
            AccessType::ReadOnly
        );
        assert_eq!(
            AccessType::from_str("write-only").unwrap(),
            AccessType::WriteOnly
        );
        assert_eq!(
            AccessType::from_str("read-write").unwrap(),
            AccessType::ReadWrite
        );
        assert_eq!(
            AccessType::from_str("writeOnce").unwrap(),
            AccessType::WriteOnce
        );
        assert_eq!(
            AccessType::from_str("read-writeOnce").unwrap(),
